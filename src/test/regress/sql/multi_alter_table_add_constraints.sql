...
SELECT master_create_empty_shard('products_append');
...
\COPY products_append FROM STDIN WITH (DELIMITER ',', append_to_shard 1450033);
1, Product_1, 10
2, Product_2, 15
1, Product_3, 8
\.
...
SELECT master_create_empty_shard('unique_test_table_append');
...
\COPY unique_test_table_append FROM STDIN WITH (DELIMITER ',', append_to_shard 1450067);
1, Product_1
2, Product_2
1, Product_3
\.
...
\COPY products_append FROM STDIN WITH (DELIMITER ',', append_to_shard 1450101);
1, Product_1, 10, 5
2, Product_2, 15, 8
1, Product_3, 8, 10
\.
...
\COPY products_append FROM STDIN WITH (DELIMITER ',', append_to_shard 1450135);
1, Product_1, 10
1, Product_2, 15
1, Product_1, 8
\.
...
\COPY products_append FROM STDIN WITH (DELIMITER ',', append_to_shard 1450169);
1, \N, 10
\N, Product_2, 15
1, Product_1, 8
\.

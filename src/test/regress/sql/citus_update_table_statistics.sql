...
SELECT master_create_empty_shard('test_table_statistics_append');
SELECT master_create_empty_shard('test_table_statistics_append');
COPY test_table_statistics_append FROM PROGRAM 'echo 0 && echo 1 && echo 2 && echo 3' WITH (format 'csv', append_to_shard 981008);
COPY test_table_statistics_append FROM PROGRAM 'echo 4 && echo 5 && echo 6 && echo 7' WITH (format 'csv', append_to_shard 981009);

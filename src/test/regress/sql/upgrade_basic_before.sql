...
SELECT master_create_empty_shard('t_range');
SELECT master_create_empty_shard('t_range');
UPDATE pg_dist_shard SET shardminvalue = '1', shardmaxvalue = '3' WHERE shardid = 102137;
UPDATE pg_dist_shard SET shardminvalue = '5', shardmaxvalue = '7' WHERE shardid = 102138;
